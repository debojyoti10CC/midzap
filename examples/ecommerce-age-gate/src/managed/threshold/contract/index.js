...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.privateValue) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named privateValue');
    }
    ...
    this.circuits = {
      proveThreshold: async (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(subjectId_0).concat(_descriptor_2.toValue(threshold_0)),
      ...
      isVerified: async (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.callContext.currentQueryContext != undefined)) {
          __compactRuntime.typeError('isVerified',
                                     'argument 1 (as invoked from Typescript)',
                                     'threshold_proof.compact line 43 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(subjectId_0.buffer instanceof ArrayBuffer && subjectId_0.BYTES_PER_ELEMENT === 1 && subjectId_0.length === 32)) {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(subjectId_0),
  ...
  _privateValue_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.callContext.currentQueryContext.state), context.callContext.currentPrivateState, context.callContext.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.privateValue(witnessContext_0);
    context.callContext.currentPrivateState = nextPrivateState_0;
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 18446744073709551615n)) {
      __compactRuntime.typeError('privateValue',
                                 'return value',
                                 'threshold_proof.compact line 31 char 1',
                                 'Uint<0..18446744073709551616>',
                                 result_0)
    }
  ...
  async _proveThreshold_0(context, partialProofData, subjectId_0, threshold_0) {
    const value_0 = this._privateValue_0(context, partialProofData);
    __compactRuntime.assert(value_0 >= threshold_0,
                            'Value does not meet required threshold');
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(subjectId_0),
  ...
  async _isVerified_0(context, partialProofData, subjectId_0) {
    const key_0 = subjectId_0;
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'threshold_proof.compact line 26 char 1',
                                     'Bytes<32>',
                                     key_0)
        }
        return _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
...
const _dummyContract = new Contract({ privateValue: (...args) => undefined });
export const pureCircuits = {};
export const contractReferenceLocations =
  { tag: 'publicLedgerArray', indices: { } };
export const expectedVk = {
  'isVerified': 'ed0a155b9ce4892be2dd541495f9033ca9d75c0bdf076364ee29399b5332685d',
  'proveThreshold': '04fb337c0f973b52b03e6e4409c4eddadc7d2a7c5a4fa21cbd8c8c57222b4b02',
};
